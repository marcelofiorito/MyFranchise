...
- 1 frase de arquitetura: *"Tudo em SAP BTP: CAP + HANA Cloud + Fiori + Work Zone + AI Core. Um dia de trabalho de franqueadora, num único fluxo."*
- Ponte para o roadmap: SAC (analytics avançado), Datasphere, Joule.
...
- [ ] Os 4 apps abrem SEM erro no Work Zone (hard refresh antes de começar)
...
- [ ] Screenshots dos 4 apps salvos localmente (teste/prints já tem alguns)
...
- [ ] Ter 1 número de impacto por ato (280 lojas, −24% de desvio, score 32, 3 recomendações)
